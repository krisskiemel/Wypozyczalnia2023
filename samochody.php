...
<body>
    <div>
        ...
        <section>
            ...
            switch ($typ) {
                case "":
                    $sql = "SELECT `vin`, `marka`, `model`, `nr_rej`, `st_licz`, `cena_km`, `cena_dz`, `miejsca`, typy_nadwozia.typ_nadwozia, typy_napedu.typ_napedu, kolory.kolor, `opis`
                    FROM samochody
                    JOIN kolory ON kolory.id_koloru = samochody.kolor
                    JOIN typy_napedu ON typy_napedu.id_typu_napedu = samochody.typ_napedu
                    JOIN typy_nadwozia ON typy_nadwozia.id_typu_nadwozia = samochody.typ_nadw";
